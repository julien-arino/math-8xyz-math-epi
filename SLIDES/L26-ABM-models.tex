...
\includegraphics[width=\textwidth]{FIGS/L26-distrib_a_b-1.pdf}
\end{minipage}
\end{frame}
...
\end{minipage}
\begin{minipage}{0.59\textwidth}
\includegraphics[width=\textwidth]{FIGS/L26-distrib_minf_b-1.pdf}
\end{minipage}
\end{frame}
...
\maxFrameImage{FIGS/L26-pdf-cdf-surv-normal-1.pdf}
...
\maxFrameImage{FIGS/L26-pdf-cdf-surv-hazard-normal-1.pdf}
...
\maxFrameImage{FIGS/L26-pdf-cdf-surv-hazard-expon-1.pdf}
...
\maxFrameImage{FIGS/L26-pdf-cdf-surv-hazard-gamma-1.pdf}
...
\begin{center}
\includegraphics[width=0.8\textwidth]{FIGS/L26-prop_surviving_exp_80years-1.pdf}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[width=0.8\textwidth]{FIGS/L26-prop_surviving_dirac_80years-1.pdf}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[width=0.75\textwidth]{FIGS/L26-prop_surviving_exp_80years_details-1.pdf}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[width=0.75\textwidth]{FIGS/L26-plot_results_optim_Erlang-1.pdf}
\end{center}
\end{frame}
...
\maxFrameImage{FIGS/L26-CTMC_birth_death_b0_01_d0_01-1.pdf}



\maxFrameImage{FIGS/L26-CTMC_birth_death_b0_01_d0_02-1.pdf}
...
\maxFrameImage{FIGS/L26-CTMC_birth_death_b0_03_d0_01-1.pdf}
...
\begin{frame}[fragile]{Last one did not go well}
    \begin{itemize}
        ...
        \item Interrupted at 289.6134642 because of the test
        \newline (Slide with $b<d$: sim stopped because the population went extinct, I did not stop it!)
        \item At stop time
        \begin{itemize}
            \item $N =$ \ensuremath{3.2837\times 10^{4}}
            \item $|N| =$ 65064 (and $|t|$ as well, of course!)
...
\end{alltt}
\begin{verbatim}
## [1] 3.177471e-03 2.098569e-03 3.570136e-04 5.186948e-05 6.822408e-04
## [6] 6.105552e-09
\end{verbatim}
...
\maxFrameImage{FIGS/L26-plot_CTMC_birth_death_b0_03_d0_01_interevent-1.pdf}
...
\maxFrameImage{FIGS/L26-sim-gillespie2-first-1.pdf}
...
\maxFrameImage{FIGS/L26-parallel-CTMC-plot-1.pdf}
