...
\begin{frame}[fragile]{Last one did not go well}
    \begin{itemize}
        ...
        \item Interrupted at 279.0103183 because of the test
        \newline (Slide with $b<d$: sim stopped because the population went extinct, I did not stop it!)
        \item At stop time
        \begin{itemize}
            \item $N =$ \ensuremath{2.6477\times 10^{4}}
            \item $|N| =$ 52742 (and $|t|$ as well, of course!)
...
\end{alltt}
\begin{verbatim}
## [1] 1.235440e-03 9.287699e-04 1.772081e-04 2.402729e-04 8.623321e-05
## [6] 2.119407e-09
\end{verbatim}
