...
\begin{frame}[fragile]{Last one did not go well}
    \begin{itemize}
        ...
        \item Interrupted at 334.734714 because of the test
        \newline (Slide with $b<d$: sim stopped because the population went extinct, I did not stop it!)
        \item At stop time
        \begin{itemize}
            \item $N =$ \ensuremath{9.4825\times 10^{4}}
            \item $|N| =$ 188918 (and $|t|$ as well, of course!)
...
\end{alltt}
\begin{verbatim}
## [1] 2.146970e-04 1.396753e-05 2.127474e-04 6.475388e-05 7.938970e-05
## [6] 5.875791e-09
\end{verbatim}
