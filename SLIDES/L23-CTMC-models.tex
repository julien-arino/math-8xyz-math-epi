...
\begin{frame}[fragile]{Last one did not go well}
    \begin{itemize}
        ...
        \item Interrupted at 306.5004148 because of the test
        \newline (Slide with $b<d$: sim stopped because the population went extinct, I did not stop it!)
        \item At stop time
        \begin{itemize}
            \item $N =$ \ensuremath{4.1792\times 10^{4}}
            \item $|N| =$ 83361 (and $|t|$ as well, of course!)
...
\end{alltt}
\begin{verbatim}
## [1] 3.880759e-04 9.737268e-05 1.435169e-03 1.051413e-03 5.459647e-04
## [6] 6.695757e-09
\end{verbatim}
\end{kframe}
\end{knitrout}
