...
\title{General information about the course \& (brief) Introduction to \code{R} and \code{julia}}
...
\begin{frame}{Word of warning!}
	The references on the previous slide are \boldred{my} favourite references
	\vfill
	This extends to the entire content of this course: the topics I treat and the way I treat them originate in \boldred{my} personal itinerary through math epi and as a consequence
	\begin{itemize}
...
% The section page
\newSectionSlide{FIGS-slides-admin/Gemini_Generated_Image_1d5vb51d5vb51d5v.png}


\begin{frame}
	Most of the programming in this course is done using the \code{R} language
	\vfill
...
##     column_1         colour         
##  Min.   :0.1690   Length:9          
##  1st Qu.:0.3958   Class :character  
##  Median :0.4303   Mode  :character  
##  Mean   :0.5237                     
##  3rd Qu.:0.7802                     
##  Max.   :0.9094
\end{verbatim}
...
## 
## [[2]]
## [1] 0.2717255 0.0958482
## 
## [[3]]
## [1] 0.27931983 0.08733973 0.71334139
\end{verbatim}
\end{kframe}
\end{knitrout}
\end{frame}
...
\end{alltt}
\begin{verbatim}
## [1] 0.1612626 0.1837868 0.3600003
\end{verbatim}
\end{kframe}
\end{knitrout}
or
...
\end{kframe}
\end{knitrout}
You can split this list, use it on different machines, etc. And can use {\tt future\_lapply}
\end{frame} 
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in wb\_data(country = "{}CAN"{}, indicator = "{}SP.POP.TOTL"{}, mrv = 100, : could not find function "{}wb\_data"{}}}\begin{alltt}
...
%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%
\section{Very brief introduction to julia}
% The section page
\newSectionSlide{FIGS-slides-admin/Gemini_Generated_Image_ubwp96ubwp96ubwp.png}

\begin{frame}
  \frametitle{What is Julia?}
  \begin{itemize}
    \item A \textbf{high-level}, \textbf{high-performance}, \textbf{dynamic} programming language
    \vfill
    ...
    \vfill
    \item Aims to solve the \textbf{"two-language problem"}
  \end{itemize}
\end{frame}
...
\begin{frame}
  ...
  \vfill
  \begin{itemize}
    \item \textbf{DataFrames.jl}: For working with tabular data (like data frames in \code{R})
    \vfill
...
\begin{frame}
  ...
  \begin{itemize}
    \item \textbf{Download Julia:} go to \href{https://julialang.org/downloads/}{\textcolor{blue}{https://julialang.org/downloads/}}
    \vfill
    \item \textbf{Official documentation:} \href{https://docs.julialang.org}{\textcolor{blue}{https://docs.julialang.org}}
    \vfill
    \item \textbf{IDE/Editor Support:}
    I recommend using VS Code
    \vfill
    \item \textbf{Start the REPL:}
    Open your terminal and type `julia` to start the interactive Read-Eval-Print Loop
  \end{itemize}
\end{frame}
...
To finish, we use the command \code{purl} to generate an \code{R} file (\code{L01-course-organisation-intro-R-julia.R}) in the CODE directory with all the code chunks in this \code{Rnw} file
\vfill
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
...
\hldef{\}}
\hlkwd{rmd_chunks_to_r_temp}\hldef{(}\hlsng{"L01-course-organisation-intro-R-julia.Rnw"}\hldef{)}
\end{alltt}
\begin{verbatim}
## [1] "../CODE/L01-course-organisation-intro-R-julia.R"
\end{verbatim}
\end{kframe}
\end{knitrout}
\end{frame}
...
Source the file \code{L01-course-organisation-intro-R-julia.R} (in the \code{CODE} directory) in \code{R} to reproduce all the results in these slides
\vfill
