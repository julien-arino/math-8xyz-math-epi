...
##     column_1         colour         
##  Min.   :0.1551   Length:9          
##  1st Qu.:0.4562   Class :character  
##  Median :0.7227   Mode  :character  
##  Mean   :0.6374                     
##  3rd Qu.:0.8365                     
##  Max.   :0.9900
\end{verbatim}
...
## 
## [[2]]
## [1] 0.7039031 0.5135628
## 
## [[3]]
## [1] 0.5523024 0.4519802 0.5929349
\end{verbatim}
\end{kframe}
\end{knitrout}
\end{frame}
...
\end{alltt}
\begin{verbatim}
## [1] 0.5862167 0.6087329 0.5324059
\end{verbatim}
\end{kframe}
\end{knitrout}
or
...
To finish, we use the command \code{purl} to generate an \code{R} file (\code{L01-course-organisation-and-intro-R-julia.R}) in the CODE directory with all the code chunks in this \code{Rnw} file
\vfill
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
...
\hldef{\}}
\hlkwd{rmd_chunks_to_r_temp}\hldef{(}\hlsng{"L01-course-organisation-and-intro-R-julia.Rnw"}\hldef{)}
\end{alltt}
...
Source the file \code{L01-course-organisation-and-intro-R-julia.R} (in the \code{CODE} directory) in \code{R} to reproduce all the results in these slides
\vfill
