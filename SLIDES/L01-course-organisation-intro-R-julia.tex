...
##     column_1         colour         
##  Min.   :0.2407   Length:9          
##  1st Qu.:0.3686   Class :character  
##  Median :0.7785   Mode  :character  
##  Mean   :0.6272                     
##  3rd Qu.:0.8560                     
##  Max.   :0.8926
\end{verbatim}
...
## 
## [[2]]
## [1] 0.4502139 0.7454907
## 
## [[3]]
## [1] 0.3714351 0.4960220 0.3938558
\end{verbatim}
\end{kframe}
\end{knitrout}
\end{frame}
...
\end{alltt}
\begin{verbatim}
## [1] 0.7058228 0.5978523 0.4204376
\end{verbatim}
\end{kframe}
\end{knitrout}
or
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in label\_number(scale = 1e-06, suffix = "{}M"{}): could not find function "{}label\_number"{}}}\end{kframe}
\end{knitrout}
\end{frame}
