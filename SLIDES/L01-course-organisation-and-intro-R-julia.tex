...
\begin{center}
	\href{https://julien-arino.github.io/math8xyz-reading-course-math-epi}{https://julien-arino.github.io/math8xyz-reading-course-math-epi}
\end{center}
\vfill
This repo includes the slides, code and data samples
\vfill
This \boldred{does not} include pdf of the bibliographic references, although there are links to articles and books and, where needed, bibliographic information at the end of a slide set. As much as possible, I link to Open Access sources
\vfill
...
\begin{frame}{Reading recommendations}
    ...
    \item Hethcote. \href{https://doi.org/10.1137/S0036144500371907}{The mathematics of infectious diseases}. SIAM Review (2000)
		\vfill
    \item Daley \& Gani. Epidemic modelling (2001)
		\vfill
...
##     column_1         colour         
##  Min.   :0.2043   Length:9          
##  1st Qu.:0.3641   Class :character  
##  Median :0.4140   Mode  :character  
##  Mean   :0.4660                     
##  3rd Qu.:0.5871                     
##  Max.   :0.7192
\end{verbatim}
...
## 
## [[2]]
## [1] 0.5518902 0.2406821
## 
## [[3]]
## [1] 0.6922259 0.5982469 0.6337687
\end{verbatim}
\end{kframe}
\end{knitrout}
\end{frame}
...
\end{alltt}
\begin{verbatim}
## [1] 0.9145447 0.3962861 0.6414138
\end{verbatim}
\end{kframe}
\end{knitrout}
or
