...
\begin{frame}{}
  \begin{center}
    \includegraphics[width=\textwidth]{FIGS/L08-SIRS_one_sim_prevalence-1.pdf}
  \end{center}
\end{frame}
...
\begin{frame}{}
  \begin{center}
    \includegraphics[width=\textwidth]{FIGS/L08-SIRS_3_sims_prevalence-1.pdf}
  \end{center}
\end{frame}
...
\begin{frame}
  \begin{center}
    \includegraphics[width=\textwidth]{FIGS/L08-SIRS_bifurcation_R0-1.pdf}
  \end{center}
\end{frame}
...
\hldef{\}}
\hlkwd{rmd_chunks_to_r_temp}\hldef{(}\hlsng{"L08-PvdD-Watmough.Rnw"}\hldef{)}
\end{alltt}
\begin{verbatim}
## [1] "../CODE/L08-PvdD-Watmough.R"
\end{verbatim}
\end{kframe}
\end{knitrout}
\end{frame}
