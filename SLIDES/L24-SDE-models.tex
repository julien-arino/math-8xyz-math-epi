...
\begin{frame}[fragile]{Last one did not go well}
    \begin{itemize}
        ...
        \item Interrupted at 293.7438232 because of the test
        \newline (Slide with $b<d$: sim stopped because the population went extinct, I did not stop it!)
        \item At stop time
        \begin{itemize}
            \item $N =$ \ensuremath{3.9892\times 10^{4}}
            \item $|N| =$ 79741 (and $|t|$ as well, of course!)
...
\end{alltt}
\begin{verbatim}
## [1] 5.921524e-04 4.944929e-05 4.488610e-04 5.311016e-04 3.788565e-04
## [6] 6.635617e-09
\end{verbatim}
