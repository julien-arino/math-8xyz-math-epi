...
\maxFrameImage{FIGS/L24-pdf-cdf-surv-normal-1.pdf}
...
\maxFrameImage{FIGS/L24-pdf-cdf-surv-hazard-normal-1.pdf}
...
\maxFrameImage{FIGS/L24-pdf-cdf-surv-hazard-expon-1.pdf}
...
\maxFrameImage{FIGS/L24-pdf-cdf-surv-hazard-gamma-1.pdf}
...
\begin{center}
\includegraphics[width=0.75\textwidth]{FIGS/L24-plot_results_optim_Erlang-1.pdf}
\end{center}
\end{frame}
...
\maxFrameImage{FIGS/L24-CTMC_birth_death_b0_01_d0_01-1.pdf}



\maxFrameImage{FIGS/L24-CTMC_birth_death_b0_01_d0_02-1.pdf}
...
\maxFrameImage{FIGS/L24-CTMC_birth_death_b0_03_d0_01-1.pdf}
...
\begin{frame}[fragile]{Last one did not go well}
    \begin{itemize}
        ...
        \item Interrupted at 314.6224371 because of the test
        \newline (Slide with $b<d$: sim stopped because the population went extinct, I did not stop it!)
        \item At stop time
        \begin{itemize}
            \item $N =$ \ensuremath{5.6796\times 10^{4}}
            \item $|N| =$ 113959 (and $|t|$ as well, of course!)
...
\end{alltt}
\begin{verbatim}
## [1] 3.351009e-06 2.212138e-05 2.776284e-04 3.606407e-04 1.632660e-03
## [6] 2.204672e-09
\end{verbatim}
...
\maxFrameImage{FIGS/L24-plot_CTMC_birth_death_b0_03_d0_01_interevent-1.pdf}
...
\maxFrameImage{FIGS/L24-sim-gillespie2-first-1.pdf}
...
\maxFrameImage{FIGS/L24-parallel-CTMC-plot-1.pdf}
