...
\begin{frame}[fragile]{Last one did not go well}
    \begin{itemize}
        ...
        \item Interrupted at 298.9017509 because of the test
        \newline (Slide with $b<d$: sim stopped because the population went extinct, I did not stop it!)
        \item At stop time
        \begin{itemize}
            \item $N =$ \ensuremath{3.4107\times 10^{4}}
            \item $|N| =$ 67760 (and $|t|$ as well, of course!)
...
\end{alltt}
\begin{verbatim}
## [1] 3.194313e-04 1.495067e-03 8.422842e-04 3.989350e-06 1.811261e-03
## [6] 7.600420e-09
\end{verbatim}
