...
\includegraphics[width=\textwidth]{FIGS/L19-distrib_a_b-1.pdf}
\end{minipage}
\end{frame}
...
\end{minipage}
\begin{minipage}{0.59\textwidth}
\includegraphics[width=\textwidth]{FIGS/L19-distrib_minf_b-1.pdf}
\end{minipage}
\end{frame}
...
\maxFrameImage{FIGS/L19-pdf-cdf-surv-normal-1.pdf}
...
\maxFrameImage{FIGS/L19-pdf-cdf-surv-hazard-normal-1.pdf}
...
\maxFrameImage{FIGS/L19-pdf-cdf-surv-hazard-expon-1.pdf}
...
\maxFrameImage{FIGS/L19-pdf-cdf-surv-hazard-gamma-1.pdf}
...
\begin{center}
\includegraphics[width=0.8\textwidth]{FIGS/L19-prop_surviving_exp_80years-1.pdf}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[width=0.8\textwidth]{FIGS/L19-prop_surviving_dirac_80years-1.pdf}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[width=0.75\textwidth]{FIGS/L19-prop_surviving_exp_80years_details-1.pdf}
\end{center}
\end{frame}
...
\begin{center}
\includegraphics[width=0.75\textwidth]{FIGS/L19-plot_results_optim_Erlang-1.pdf}
\end{center}
\end{frame}
...
\maxFrameImage{FIGS/L19-CTMC_birth_death_b0_01_d0_01-1.pdf}



\maxFrameImage{FIGS/L19-CTMC_birth_death_b0_01_d0_02-1.pdf}
...
\maxFrameImage{FIGS/L19-CTMC_birth_death_b0_03_d0_01-1.pdf}
...
\begin{frame}[fragile]{Last one did not go well}
    \begin{itemize}
        ...
        \item Interrupted at 324.7255089 because of the test
        \newline (Slide with $b<d$: sim stopped because the population went extinct, I did not stop it!)
        \item At stop time
        \begin{itemize}
            \item $N =$ \ensuremath{5.8278\times 10^{4}}
            \item $|N| =$ 116085 (and $|t|$ as well, of course!)
...
\end{alltt}
\begin{verbatim}
## [1] 1.885974e-04 6.686385e-04 1.453916e-04 5.989438e-04 4.190372e-04
## [6] 1.739522e-09
\end{verbatim}
...
\maxFrameImage{FIGS/L19-plot_CTMC_birth_death_b0_03_d0_01_interevent-1.pdf}
...
\maxFrameImage{FIGS/L19-sim-gillespie2-first-1.pdf}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: Cannot create 128 parallel PSOCK nodes. Each node needs one connection, but there are only 123 connections left out of the maximum 128 available on this R installation. To increase this limit in R (>= 4.4.0), use command-line option '--max-connections=N' when launching R.}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'SIMS' not found}}\begin{alltt}
\hlcom{# Now plot}
...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error: object 'SIMS' not found}}
\end{knitrout}
...
\maxFrameImage{FIGS/L19-parallel-CTMC-plot-1.pdf}
